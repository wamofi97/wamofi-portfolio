      ...
      <div className="max-w-6xl mx-auto px-4 py-20 flex flex-wrap sm:flex-nowrap gap-x-6 gap-y-12 items-center">
        <div className="space-y-2 text-center sm:text-left">
          ...
          <div className="flex flex-wrap sm:justify-start justify-center items-center gap-3">
            <a 
              href="#projects"
              className="group relative inline-flex items-center gap-2 bg-slate-600 text-white px-4 py-2 rounded-full text-lg font-medium hover:bg-slate-700 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
            >
              See My Work
            ...
            <a 
              href={resume}
              download
              className="inline-flex items-center gap-2 bg-white text-slate-600 px-4 py-2 rounded-full text-lg font-medium border-2 border-slate-200 hover:border-slate-600 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
            >
              <FileUser className="w-5 h-5" />
              Resume
            </a>
            <div className="flex items-center justify-center sm:justify-start gap-1">
              <a href="https://github.com/wamofi97"  target='_blank'className="bg-white text-slate-600 p-3 rounded-full text-lg font-medium hover:border-slate-600 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <Github className="w-5 h-5" />
              </a>
              <a href="https://linkedin.com/in/wanfirdausfauzi" target='_blank' className=" bg-white text-slate-600 p-3 rounded-full text-lg font-medium  hover:border-slate-600 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="mailto:wamofi97@gmail.com" target='_blank' className="bg-white text-slate-600 p-3 rounded-full text-lg font-medium hover:border-slate-600 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="relative group h-full min-w-60 mx-auto">
          ...
          <div onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} className="relative bg-white p-4 rounded-full shadow-xl rotate-3 hover:rotate-0 transition-transform duration-300">
            ...
            <div className={`${!show && 'sm:scale-0'} scale-100 flex gap-0.5 w-full left-0 justify-center flex-wrap absolute sm:top-3/4 top-2/3 transition-transform duration-300`}>
                ...
                <img 
                  ...
                  alt="Profile"
                  className="sm:h-96 h-72 object-cover rounded-full transition-all duration-300"
                />
          </div>
        </div>
      </div>
