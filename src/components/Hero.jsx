    ...
    <section className="flex md:flex-row flex-col items-center justify-center gap-x-8 gap-y-4 py-20 px-4">
        ...
        <div className="space-y-4">
          <div className="space-y-2 flex flex-col md:text-start text-center">
            ...
            <p className='flex items-center w-fit md:mx-0 mx-auto bg-neutral-300/50 dark:bg-neutral-800/40 px-4 py-2 rounded-full text-sm animate-float'><span className='w-[6px] h-[6px] rounded-full bg-teal-600 dark:bg-teal-300 mr-2 animate-pulse'></span>Based from Malaysia<img className='w-4 ml-2 inline' src={malaysia} alt="malaysia flag" /></p>  
            <h1 className='lg:text-6xl md:text-5xl sm:text-4xl text-3xl font-semibold'> Hi, I'm <span className='gradient-text font-bold'>Wan Firdaus</span> <span className=" animate-wave">👋 </span></h1>
            <h2 className="md:text-3xl sm:text-2xl text-xl font-light">A <span className=' font-semibold'>frontend developer</span> that love to learn and build things.
            </h2>
          </div>
