...
export default function Hero() {
  ...
  return (
    <section className=" min-h-[75vh] flex items-center justify-center">
      <div className="max-w-5xl px-4 py-20 flex flex-wrap sm:flex-nowrap gap-x-12 gap-y-8 items-center justify-center">
        ...
        <div className="space-y-2 text-center sm:text-left">
          <div className="space-y-4 text-center sm:text-left">
            ...
            <h1 className="sm:text-5xl text-4xl font-body font-bold tracking-tight ">
              ...
              <span className="text-neutral-100">Wan Firdaus</span> 
              <span className='text-xl font-extralight block mt-1'></span>
              <span className="block sm:text-6xl text-4xl font-heading tracking-wide gradient-text">FRONTEND DEVELOPER</span>
            </h1>
          </div>
